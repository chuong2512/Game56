...
public class Key
{
    public const string PACK1 = "game56_pack1";
    public const string PACK2 = "game56_pack2";
    public const string PACK3 = "game56_pack3";
    public const string PACK4 = "game56_pack4";
    public const string PACK5 = "game56_pack5";
    public const string PACK6 = "game55_pack6";


    public const string PACK1_REGISTER = "register_game56_pack1";
    public const string PACK2_REGISTER = "register_game56_pack2";
    public const string PACK3_REGISTER = "register_game56_pack3";
    public const string PACK4_REGISTER = "register_game56_pack4";
    public const string PACK5_REGISTER = "register_game56_pack5";
}
